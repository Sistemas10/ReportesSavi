...
<%
    ...
    String folio_gnk = "", fecha = "", folio_remi = "", orden = "", provee = "", recib = "", entrega = "", origen = "", coincide = "", observaciones = "", clave = "", descrip = "", Cb="", Marca="", Codbar2="";
    int Cuenta = 0;
    try {
                                ...
                                <div class="col-sm-2">
                                    <select class="form-control" name="list_lote" onKeyPress="return tabular(event, this)" id="list_lote" onchange="lotes();">
                                        ...
                                        <%
                                            try {
                                                con.conectar();
                                                ResultSet rset = con.consulta("SELECT F_ClaLot FROM tb_cb WHERE F_Cb='"+Cb+"' GROUP BY F_ClaLot");
                                                while (rset.next()) {
                                ...
                                <div class="col-sm-2">
                                    <select class="form-control" name="list_cadu" onKeyPress="return tabular(event, this)" id="list_cadu" onchange="cadu();">
                                        ...
                                        <%
                                            try {
                                                con.conectar();
                                                ResultSet rset = con.consulta("SELECT DATE_FORMAT(F_FecCad,'%d/%m/%Y') as caducidad FROM tb_cb WHERE F_Cb='"+Cb+"' GROUP BY F_FecCad");
                                                while (rset.next()) {
                                ...
                                <div class="col-sm-2">
                                 ...
                                 <select class="form-control" name="list_fabri" onKeyPress="return tabular(event, this)" id="list_fabri" onchange="fabri();">
                                        ...
                                        <%
                                            try {
                                                con.conectar();
                                                ResultSet rset = con.consulta("SELECT DATE_FORMAT(F_FecFab,'%d/%m/%Y') as fabricacion FROM tb_cb WHERE F_Cb='"+Cb+"' GROUP BY F_FecFab");
                                                while (rset.next()) {
